...
router.get("/update_live_scoress/:matchId", async (req, res) => {
   ...
   message: "All matches processed successfully"
});
        } else {
   ...
   message: "All matches processed successfully"
      ...
      headers: {
        ...
        for (const matchDoc of matches) {
            ...
            const apiUrl = `https://Cricbuzz-Official-Cricket-API.proxy-production.allthingsdev.co/match/${matchId}`;
